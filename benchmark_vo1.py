...
def main():
    ...
    print(f"After model creation: {memory_mb():.2f} MB")

    model = model.half()

    print(f"After converting model to FP16: {memory_mb():.2f} MB")
    ...
    print(f"After FP16 checkpoint load: {memory_mb():.2f} MB")

    model.load_state_dict(state)

    print(f"After state_dict load: {memory_mb():.2f} MB")
